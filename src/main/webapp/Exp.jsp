          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="form-elements">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"><a class="nav-link" href="Inc.jsp">Bank</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
                        ...
                        <tbody>
                        	...
                        	<c:forEach var="expense" items="${expenses}">                     	
        						<tr>
            						...
            						<td>${expense.name}</td>
           							<td>${expense.expenseSourceId.incomeExpenseSource}</td> 
           							<td class="text-danger">${Math.abs(expense.expense)}<i class="ti-arrow-down"></i></td>
        						</tr>
    						</c:forEach>
                        </tbody>
                      </table>
